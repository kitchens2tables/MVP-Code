				...
				<div class="box-content">
					<form class="woocommerce-cart-form" action="<?php echo esc_url( version_compare( $porto_woo_version, '2.5', '<' ) ? WC()->cart->get_cart_url() : wc_get_cart_url() ); ?>" method="post">
										...
										<tr class="<?php echo esc_attr( apply_filters( 'woocommerce_cart_item_class', 'cart_item', $cart_item, $cart_item_key ) ); ?>">
											...
											<td class="product-name">
												...
												if ( ! $product_permalink ) {
													...
													echo wp_kses_post( apply_filters( 'woocommerce_cart_item_name', sprintf( '<a href="%s">%s</a>', '#', $_product->get_name() ), $cart_item, $cart_item_key ) );
												}
												// Meta data
						...
						<div class="cart-actions">
							<a class="btn btn-default" href="<?php echo SITE_URL().'/cooks'; ?>"><?php esc_html_e( 'Order More', 'porto' ); ?></a>
