...
function wc_get_account_orders_columns() {
	$columns = apply_filters(
		'woocommerce_account_orders_columns', array(
                ...
                'order-vendor_name'  => __( 'Cook', 'woocommerce' ),
                'order-date'    => __( 'Order Date', 'woocommerce' ),
                'order-dish_name'    => __( 'Dish', 'woocommerce' ),
                'order-status'  => __( 'Status', 'woocommerce' ),
                'order-product_rating'  => __( 'Rating', 'woocommerce' ),
                'order-product_feedback'  => __( 'Feedback', 'woocommerce' ),
