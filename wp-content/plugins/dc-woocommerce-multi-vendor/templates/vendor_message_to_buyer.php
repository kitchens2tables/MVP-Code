...
//            ) {
        ...
        <?php if ($cc == 0) { ?>
                    <tr>
                        <th style="padding:10px 10px; background:none; border-right: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; width:50%;" align="left" valign="top"><?php echo __('Cook Details', 'dc-woocommerce-multi-vendor'); ?></th>
        ...
        <?php } ?>
                <tr> 
                    <td style="padding:10px 10px; background:none; border-right: 1px solid #e4e4e4; border-bottom: 1px solid #e4e4e4; width:50%;" align="left" valign="top">
                        <p><strong><?php echo __('Cook Name', 'dc-woocommerce-multi-vendor'); ?> </strong><br>
                            <?php    
