...
<?php if ( 'v2' == porto_cart_version() && is_cart() ) : ?>
	<div class="card card-default woocommerce-shipping-totals shipping TEST">
					...
					<ul id="shipping_method" class="woocommerce-shipping-methods">
						<?php foreach ( $available_methods as $method ) : ?>
							<li>
								...
								printf( '<label for="shipping_method_%1$s_%2$s">NA</label>', $index, esc_attr( sanitize_title( $method->id ) ), wc_cart_totals_shipping_method_label( $method ) ); // WPCS: XSS ok.
...
<?php else : ?>
	<tr class="woocommerce-shipping-totals shipping">
		...
		<th><?php $pac_data = explode(' ', $package_name);

		$pac_d=$pac_data[1];

		 echo wp_kses_post( $pac_d);
