...
<div><span>Zip</span></div></div>
<div><span>Price</span></div>
<div><span>Cuisine</span></div>
<div><span>Delivery</span></div>-->			
			<form method="get" action="<?php echo site_url('/cooks/');?>">
 ...
 ?>
				...
				<div class="um-search-submit">
					...
					<a href="#" class="um-button um-do-search"><?php echo _e('Search','ultimate-member'); 
