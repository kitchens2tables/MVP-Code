		...
		<div class="container">
			...
			<div class="header-right">
				<div>
					...
					<div class="block-nowrap position-relative">
					<?php
						// show search form
						/*echo porto_search_form();*/
                                        ...
                                        <span class="user-logged-in">Welcome  <?php 
                                        ...
                                        <a href="<?php echo wp_logout_url(SITE_URL()); ?>" ><i class="fa fa-power-off"></i> Logout </a>
                                         </div>   
                                            <?php }
