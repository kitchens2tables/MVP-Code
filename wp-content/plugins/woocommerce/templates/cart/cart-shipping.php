...
<tr class="woocommerce-shipping-totals shipping">
	...
	<td data-title="<?php echo esc_attr( $package_name ); ?>">
		<?php if ( $available_methods ) : ?>
			<ul id="shipping_method" class="woocommerce-shipping-methods test" >
				<?php foreach ( $available_methods as $method ) : ?>
					<li>
						...
						printf( '<label test for="shipping_method_%1$s_%2$s">NA</label>', $index, esc_attr( sanitize_title( $method->id ) ), wc_cart_totals_shipping_method_label( $method ) ); // WPCS: XSS ok.
