...
(function (theme, $, undefined) {
    ...
    // new updated code by girish
    $("#first_name-2709, #last_name-2709, #user_email-2709, #user_password-2709, #confirm_user_password-2709").keyup(function(){
      $(".um-field-error").hide();
      
    });
    $("#first_name-2695, #last_name-2695, #user_email-2695, #user_password-2695, #confirm_user_password-2695").keyup(function(){
      $(".um-field-error").hide();
    });
    
    $("#nav-menu-item-2673, #nav-menu-item-2602").click(function(){
        $(".um-field-error").hide();
    });
    
    //end of new updated code by girish
