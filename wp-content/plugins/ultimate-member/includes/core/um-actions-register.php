...
function um_after_insert_user( $user_id, $args ) {
	...
	if ( ! empty( $args['submitted'] ) ) {
        ...
        //update_user_meta($user_id,'account_status',um_user( 'status' )); 
...
function um_add_submit_button_to_register( $args ) {
	...
	<div class="um-col-alt">
		...
		<?php } else { ?>
			...
			<div class="um-center">
                            <?php if($args['form_id'] == '2709') { ?>
                                <input type="submit" id="um-submit-btn-2709" style="display:none" />
                        	<input type="button" value="<?php esc_attr_e( wp_unslash( $primary_btn_word ), 'ultimate-member' ) ?>" class="um-button register-btn submit-customer-register-form" id="um-submit-btn" />
                            <?php } elseif($args['form_id'] == '2695') { ?>
                                <input type="submit" id="um-submit-btn-2695" style="display:none" />
                        	<input type="button" value="<?php esc_attr_e( wp_unslash( $primary_btn_word ), 'ultimate-member' ) ?>" class="um-button register-btn submit-become-chef-form" id="um-submit-btn" />
                            <?php } else { ?>
				<input type="submit" value="<?php esc_attr_e( wp_unslash( $primary_btn_word ), 'ultimate-member' ) ?>" class="um-button register-btn" id="um-submit-btn" />
                            <?php } ?>
			</div>
